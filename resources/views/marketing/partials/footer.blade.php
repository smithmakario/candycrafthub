<footer class="w-full py-xl px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-4 gap-xl bg-surface-container-lowest border-t border-outline-variant">
